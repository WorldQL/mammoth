...
public final class Message extends Table {
  ...
  public com.worldql.client.Messages.Record records(com.worldql.client.Messages.Record obj, int j) { int o = __offset(12); return o != 0 ? obj.__assign(__indirect(__vector(o) + j * 4), bb) : null; }
  ...
  public com.worldql.client.Messages.Record.Vector recordsVector(com.worldql.client.Messages.Record.Vector obj) { int o = __offset(12); return o != 0 ? obj.__assign(__vector(o), 4, bb) : null; }
  public com.worldql.client.Messages.Entity entities(int j) { return entities(new com.worldql.client.Messages.Entity(), j); }
  public com.worldql.client.Messages.Entity entities(com.worldql.client.Messages.Entity obj, int j) { int o = __offset(14); return o != 0 ? obj.__assign(__indirect(__vector(o) + j * 4), bb) : null; }
  ...
  public com.worldql.client.Messages.Entity.Vector entitiesVector(com.worldql.client.Messages.Entity.Vector obj) { int o = __offset(14); return o != 0 ? obj.__assign(__vector(o), 4, bb) : null; }
  public com.worldql.client.Messages.Vec3d position() { return position(new com.worldql.client.Messages.Vec3d()); }
  public com.worldql.client.Messages.Vec3d position(com.worldql.client.Messages.Vec3d obj) { int o = __offset(16); return o != 0 ? obj.__assign(o + bb_pos, bb) : null; }
