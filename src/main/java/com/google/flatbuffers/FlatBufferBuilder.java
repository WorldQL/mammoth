...
public class FlatBufferBuilder {
   ...
   */
    ...
    * <li>`Monster#endMonster(FlatBufferBuilder)` will ensure endObject() is called.</li>
    * </ul>
    * <p>
    * It's not recommended calling this method directly.  If it's called manually, you must ensure
